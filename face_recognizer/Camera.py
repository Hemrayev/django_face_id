...
while True:
    ...
    if (ret0):
        ...
        for index, (x, y, w, h) in enumerate(face_locations0):
            ...
            cv2.imwrite('/home/asus/PycharmProjects/Beta_version/face_recognizer/Faces_in/face_in_' + str(index) + '.jpg',
                faces)
    ...
    if (ret1):
        ...
        for index, (x, y, w, h) in enumerate(face_locations1):
            ...
            #         h *= 4
            faces = img1[x:w, h:y]
            cv2.imwrite('/home/asus/PycharmProjects/Beta_version/face_recognizer/Faces_out/Faces_out/face_out_' + str(index) + '.jpg',
                faces)
